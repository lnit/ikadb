...
MainWeapon.find_by(name: "デュアルスイーパー").update_attributes(real_damage: 28.0, max_damage: nil)
MainWeapon.find_by(name: "N-ZAP").update_attributes(real_damage: 28.0, max_damage: nil)
